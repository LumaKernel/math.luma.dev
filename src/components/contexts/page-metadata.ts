...
export const PageMetaDataContext = createContext<null | PageMetaDataContextType>(null);

export const usePageMetaData = (initial: PageMetaDataContextType): PageMetaDataContextType => {
  return initial;
};
