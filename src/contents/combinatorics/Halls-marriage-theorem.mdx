...
一般のグラフへと一般化するとTutteの定理 ([るまブログでの紹介記事](https://tomorinao.blogspot.com/2018/07/tutte.html)) となる
...
* [AGC029F - Construction of a tree (2200) - AtCoder](https://atcoder.jp/contests/agc029/tasks/agc029_f)

重み付き結婚定理

* [G. Allowed Letters - codeforces](https://codeforces.com/contest/1009/problem/G)

# 参考

* [Hall's marriage theorem - Wikipedia (en)](https://en.wikipedia.org/wiki/Hall%27s_marriage_theorem)
* [Hallの結婚定理とその証明 - 高校数学の美しい物語](https://mathtrain.jp/hall)
